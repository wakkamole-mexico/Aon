      ...
      <div className='servicios__bullets column'>
        <div className='bullets__container'>
          ...
          <p>
            ...
            Mapeo de riesgos
            <br />
            Práctica Global de C&I – P&U LATAM
            <br />
            ...
            de Riesgos (GRMS)
            <br />
            Facilities para cotización en línea de maquinaria
            y equipo
            <br />
        ...
        <div className='bullets__container'>
          ...
          <p>
            ...
            <br />
            Administración del líneas de afianzamiento, emisiones,
            vencimientos, renovaciones, cancelaciones y cobranza
            <br />
