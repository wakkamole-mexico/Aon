  ...
  return (
    <div className='riesgo__item'>
      ...
      <div className='riesgos__bullets'>
        ...
        <p>
          Riesgo asociado con el rápido ritmo en el que cambian los factores del riesgo geopolítico y del mercado y afectan a las empresas para mantener el ritmo. Esto incluye cambios legislativos, cambios de gobierno, tratados internacionales, seguridad y desempleo.
        </p>
